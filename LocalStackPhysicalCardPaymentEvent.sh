aws sqs send-message \
  --message-body '{
      "type": "TRANSACTION",
      "subtype": "PAYMENT",
      "messageId": "MSG-CARD-9b7c1e0a-02",
      "dni": "7982456032",
      "origin": "CARD_GATEWAY",
      "typeTransaction": "PHYSICAL_CARD",
      ...
      "merchant": {"merchantId": "MER-44129","mcc": "5732","name": "Tienda MusiTech"},
      "billing": {"addressLine": "Calle 45 # 20-11","city": "Bogotá","postalCode": "110231","country": "CO"},
      "fraud": {"riskScore": 0.17,"rulesTriggered": ["velocity_low","device_known"],"deviceFingerprint": "dfp-8c2f7b"},
      "items": [
      ...
      "channelInfo": {"platform": "ANDROID","appVersion": "2.14.3","ip": "181.60.45.200"},
